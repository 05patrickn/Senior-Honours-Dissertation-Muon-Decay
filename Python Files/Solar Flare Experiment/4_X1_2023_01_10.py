...
file_path = "C:/Users/05pat/OneDrive/Escritorio/OneDrive - University of Edinburgh/Year 4/Senior Honours/Python Files/Solar Flair/Flair data/X1_22_47_10_01_2023.txt"
...
marker_time = datetime.strptime("2023-01-10 22:47:00", "%Y-%m-%d %H:%M:%S")
...
plt.axvline(x=marker_time, color='r', linestyle='--', label='X1 flair at 10/01/2023, 22:47')

# Formatting the plot
plt.xlabel('Date')
plt.ylabel('Average Counts [Arb. Units]')
plt.title('Average Muon counts over time during X1 flair event on 10/01/2023, 22:47')
plt.legend()
