...
file_path = "C:/Users/05pat/OneDrive/Escritorio/OneDrive - University of Edinburgh/Year 4/Senior Honours/Python Files/Solar Flair/Flair data/X1.3_17_37_30_03_2022.txt"
...
marker_time = datetime.strptime("2022-03-30 17:37:00", "%Y-%m-%d %H:%M:%S")
...
plt.axvline(x=marker_time, color='r', linestyle='--', label='X1.3 flair at 30/03/2022, 17:37')

# Formatting the plot
plt.xlabel('Date')
plt.ylabel('Average Counts [Arb. Units]')
plt.title('Average Muon counts over time during X1.3 flair event on 30/03/2022, 17:37')
plt.legend()
