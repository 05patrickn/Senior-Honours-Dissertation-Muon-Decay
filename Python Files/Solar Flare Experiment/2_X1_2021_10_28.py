...
file_path = "C:/Users/05pat/OneDrive/Escritorio/OneDrive - University of Edinburgh/Year 4/Senior Honours/Python Files/Solar Flair/Flair data/X1_15_35_28_10_2021.txt"
...
marker_time = datetime(2021, 10, 28, 15, 35)
...
plt.axvline(x=marker_time, color='r', linestyle='--', label='X1 flair at 28/10/2021 15:35')

# Formatting the plot
plt.xlabel('Date')
plt.ylabel('Average Counts [Arb. Units]')
plt.title('Average Muon counts over time during X1 flair event on 28/10/2021, 15:35')
plt.legend()
...
# Set the minimum x-axis interval to 3 hours
