...
file_path = "C:/Users/05pat/OneDrive/Escritorio/OneDrive - University of Edinburgh/Year 4/Senior Honours/Python Files/Solar Flair/Flair data/X2.2_20_16_17_02_2023.txt"
...
marker_time = datetime.strptime("2023-02-17 20:16:00", "%Y-%m-%d %H:%M:%S")
...
plt.axvline(x=marker_time, color='r', linestyle='--', label='X2.2 flair at 17/02/2023, 20:16')
